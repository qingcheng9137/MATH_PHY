...
% ATTENTION:natural spline isn't inline function.
...
% ATTENTION:xx is vector desired values of dependent variables
%           yy is vector of interpolated values at xx
n=length(x);
if length(y)~=n,error('x and y must have a same dimension');end
...
% perform interpolations at desired values
for i=1:m
